...
import porfolioOne from "~/assets/img/babies/img1.jpg";
import porfolioTwo from "~/assets/img/babies/img2.jpg";
import porfolioThree from "~/assets/img/babies/img3.jpg";
