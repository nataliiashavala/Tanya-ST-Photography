...
<template>
  <div :class="['flex flex-col  space-y-10 lg:space-y-14', containerClasses]">
    <div
      class="flex flex-col my-9 lg:flex-row mt-2 lg:mt-10 space-y-8 lg:space-y-0 space-x-8 px-6 sm:px-8 md:px-20 lg:px-64"
    >
    ...
    <div
      class="flex flex-col justify-center items-center lg:flex-row justify-center space-x-8 px-6 sm:px-8 md:px-20 lg:px-64"
    >
